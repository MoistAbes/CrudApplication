...
public class TrelloFacadeTest {
    ...
    void shouldFetchEmptyList(){
        ...
        assertThat(trelloBoardDtoList.size()).isEqualTo(0);
    }
    ...
    void shouldCreateTrelloCard(){
        ...
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("1", "testName", "testUrl", new TrelloBadgesDto());
        ...
        //Then
        assertThat(createdTrelloCardDtoResult).isNotNull();
        assertEquals("testName", createdTrelloCardDtoResult.getName());
        assertEquals("1", createdTrelloCardDtoResult.getId());
        assertEquals("testUrl", createdTrelloCardDtoResult.getShortUrl());
        assertThat(createdTrelloCardDtoResult.getBadges()).isNotNull();

    }

    @Test
    void shouldCreateEmptyTrelloCard(){
        //Given
        ...
        //Then
        assertThat(createdTrelloCardDtoResult).isNotNull();
        assertThat( createdTrelloCardDtoResult.getName()).isNull();
        assertThat( createdTrelloCardDtoResult.getId()).isNull();
        assertThat( createdTrelloCardDtoResult.getShortUrl()).isNull();
        assertThat(createdTrelloCardDtoResult.getBadges()).isNull();
